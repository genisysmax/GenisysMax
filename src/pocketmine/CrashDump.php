...
class CrashDump
{
    ...
    private const string PLUGIN_INVOLVEMENT_NONE = "none";
    private const string PLUGIN_INVOLVEMENT_DIRECT = "direct";
    private const string PLUGIN_INVOLVEMENT_INDIRECT = "indirect";
    ...
    private function baseCrash(): void{
        ...
        foreach (($this->data["trace"] = $error["trace"]) as $line) {
            $this->addLine(
                $line instanceof ThreadCrashInfoFrame ? $line->getPrintableFrame() : ""
            );
        }
        $this->addLine();
    }
    ...
    private function generalData(): void{
        ...
        $this->addLine("OS: " . PHP_OS . ", " . Utils::getOS()->name);
