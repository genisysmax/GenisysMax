...
class Effect{
	...
	public const int FATIGUE = 4, MINING_FATIGUE = 4;
	public const int STRENGTH = 5;
	public const int INSTANT_HEALTH = 6, HEALING = 6;
	public const int INSTANT_DAMAGE = 7, HARMING = 7;
	public const int JUMP_BOOST = 8, JUMP = 8;
	public const int NAUSEA = 9, CONFUSION = 9;
	public const int REGENERATION = 10;
	public const int RESISTANCE = 11, DAMAGE_RESISTANCE = 11;
	...
	public const int CONDUIT_POWER = 26;
