...
namespace pocketmine\network\bedrock\adapter\v388\protocol;

use pocketmine\network\bedrock\adapter\v388\palette\BlockPalette;
use pocketmine\network\bedrock\adapter\v388\palette\ItemPalette;
use pocketmine\network\bedrock\protocol\types\PlayerMovementSettings;
use pocketmine\network\bedrock\protocol\types\PlayerMovementType;

class StartGamePacket extends \pocketmine\network\bedrock\adapter\v390\protocol\StartGamePacket {
	use PacketTrait;
