...
trait Pre422BlockPaletteSerializer{
    ...
    public static function init() : void{
        ...
        $legacyStateMap = [];
        $legacyStateMapReader = new NetworkBinaryStream(file_get_contents(\pocketmine\RESOURCE_PATH . "bedrock/v".self::PROTOCOL."/r12_to_current_block_map.bin"));
