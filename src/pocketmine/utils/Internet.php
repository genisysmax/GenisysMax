...
class Internet{
	public static false|string $ip = false;
     ...
     */
    public static function getURL(string $page, int $timeout = 10, array $extraHeaders = [], &$err = null, &$headers = null, &$httpCode = null): false|string{
        try{
     ...
     * @phpstan-param array<string, string>        $headers
     */
    public static function postURL(string $page, $args, int $timeout = 10, array $extraHeaders = [], &$err = null, &$headers = null, &$httpCode = null): false|string{
        try{
            list($ret, $headers, $httpCode) = self::simpleCurl($page, $timeout, $extraHeaders, [
                CURLOPT_POST => 1,
